 ...
 * @since 1.0.0
 */
class WPR_Header_02 extends Widget_Base
{
    ...
    {
        return __(WPRCORE_THEME_NAME . ' - Header 2', 'wprealizer');
    }
    ...
    protected function render()
    {
        ...
        $this->tp_link_attributes_render('header_btn', 'tp-btn-inner tp-el-btn2 common-btn square-btn', $this->get_settings());

?>

        <!-- header-area-start -->
        <header>
            <div id="<?php echo esc_attr($is_sticky); ?>" class="tp_el_header wpr-header-2 <?php echo esc_attr($edit_class); ?>">
                <!-- Menu -->
                <div class="menu-area">
...
$widgets_manager->register(new WPR_Header_02());
