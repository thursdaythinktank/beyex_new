...
class TP_Footer_Lets_Contact extends Widget_Base
{
	...
	{
		return __(WPRCORE_THEME_NAME . ' :: Footer Language', 'wprealizer');
	}
	...
	{
		// layout Panel
		$this->wpr_design_layout('Layout Style', 2);
	}
...
?>
		<?php if ($settings['wpr_design_style']  == 'layout-2') : ?>
			<div class="header-bottom__lang wpr-header-info-item">
				<?php echo wprealizer_header_lang_defualt(); ?>
			</div>

		<?php else : ?>
			<div class="header-bottom__lang-2 d-inline-block">
				<?php echo wprealizer_footer_lang_defualt(); ?>
			</div>
