...
use \WPR_ELEMENTOR\Templates\WPR_Api;
use \WPR_ELEMENTOR\Templates\WPR_Templates as WPR_init;
...
class WPR_Load
{
    ...
    {
        include WPR_init::dir() . 'templates.php';
    }

    public static function get_library()
    {
        if (is_null(self::$library_data)) {
            self::$library_data = new WPR_Api();
        }
