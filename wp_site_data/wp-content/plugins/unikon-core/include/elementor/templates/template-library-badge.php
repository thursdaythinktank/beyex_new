<script type="text/template" id="tpcore-liteTemplateLibrary_templates">
	<div id="liteTemplateLibrary_toolbar">
		<div id="liteTemplateLibrary_toolbar-search">
			<label for="liteTemplateLibrary_search" class="elementor-screen-only"><?php esc_html_e( 'Search Templates:', 'wprealizer' ); ?></label>
			<input id="liteTemplateLibrary_search" placeholder="<?php esc_attr_e( 'Search', 'wprealizer' ); ?>">
		...
		<div id="liteTemplateLibrary_toolbar-filter" class="liteTemplateLibrary_toolbar-filter">
			<# if (tpcore.library.getTypeTags()) { var selectedTag = tpcore.library.getFilter( 'tags' ); #>
				...
				<# } else { #>
				<span class="liteTemplateLibrary_filter-btn"><?php esc_html_e( 'Filter', 'wprealizer' ); ?> <i class="eicon-caret-right"></i></span>
				<# } #>
