<?php
class TP_Offcanvas_Post
{

    private $type = 'wpr-offcanvas';
    private $slug;
    private $name;
    private $plural_name;
    ...
    {
        $this->name = __('Offcanvas', 'wprealizer');
        $this->slug = 'wpr-offcanvas';
        $this->plural_name = __('Offcanvas', 'wprealizer');
