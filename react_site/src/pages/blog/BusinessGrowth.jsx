...
import { ContentSection, Callout, CheckList, StatCard } from '../../components/ui/ContentElements';
    ...
    >
      <ContentSection>
        ...
        <p className="text-apple-gray-700 leading-relaxed mb-4">
          ...
          doing the work your window display used to do.
        </p>
        <p className="text-apple-gray-700 leading-relaxed">
          This is where a 3D digital tour changes everything. Instead of a handful of flat photos, a
          virtual tour lets potential customers step inside your space online and explore it
          dynamically as if they were standing there. For a small or local business, this is a
          simple, highly effective, and affordable way to stand out, build trust, and drive physical
          foot traffic.
        </p>
      </ContentSection>

      <ContentSection>
        <h2 className="text-3xl font-semibold text-apple-gray-900 mb-6">Customers choose what they can see</h2>
        <p className="text-apple-gray-700 leading-relaxed mb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-8">
          <StatCard value="94%" label="more likely to see a listing with a virtual tour as reputable" />
          <StatCard value="2×" label="as likely to generate customer interest or bookings" />
        </div>
        <p className="text-apple-gray-500 text-sm mb-4">
          Source: Google Street View study, 2015.
        </p>
        <p className="text-apple-gray-700 leading-relaxed">
      ...
      <ContentSection shaded>
        <h2 className="text-3xl font-semibold text-apple-gray-900 mb-6">It works around the clock</h2>
        <p className="text-apple-gray-700 leading-relaxed">
      ...
      <ContentSection>
        <h2 className="text-3xl font-semibold text-apple-gray-900 mb-6">It builds trust and attracts the right customers</h2>
        <p className="text-apple-gray-700 leading-relaxed">
      ...
      <ContentSection>
        <h2 className="text-3xl font-semibold text-apple-gray-900 mb-6">It helps you reach beyond your physical location</h2>
        <p className="text-apple-gray-700 leading-relaxed">
      ...
      <ContentSection>
        <h2 className="text-3xl font-semibold text-apple-gray-900 mb-6">The benefits go beyond marketing</h2>
        <p className="text-apple-gray-700 leading-relaxed mb-6">
          ...
          your layout with high accuracy, you can use it to:
        </p>
        <CheckList
          items={[
        ...
        />
        <p className="text-apple-gray-700 leading-relaxed mt-6">
          For a busy business owner, this translates to real time and money saved.
        </p>
      </ContentSection>

      <ContentSection>
        <h2 className="text-3xl font-semibold text-apple-gray-900 mb-6">It is more affordable than most owners expect</h2>
        <p className="text-apple-gray-700 leading-relaxed mb-4">
          Many small business owners assume interactive tour technology is only for major
          corporations or luxury real estate. It isn't. A one-off capture session provides a
        ...
        <Callout title="Tip" variant="blue">
          Wondering what a tour would cost for your space? See our{' '}
          <Link to="/pricing" className="underline hover:no-underline">pricing page</Link> for clear
          price bands, or read{' '}
          <Link to="/blog/3d-virtual-tour-cost-uk" className="underline hover:no-underline">
      ...
      <ContentSection>
        ...
        <p className="text-apple-gray-700 leading-relaxed">
          ...
          <Link to="/contact" className="text-apple-blue-600 hover:underline">get in touch with us</Link>{' '}
          today and we'll show you what is possible.
        </p>
      </ContentSection>
    </ContentPageLayout>
  );
