  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <SEOHead
        ...
        description="Beyex 3D virtual tours start from £111. Contact us for a tailored quote for your space."
        ...
        <section className="pt-32 pb-24 px-6 min-h-[70vh] flex items-center">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-2xl text-apple-gray-700 mb-4">
              Our pricing starts from <span className="font-semibold text-apple-gray-900">£111</span>.
            </p>
